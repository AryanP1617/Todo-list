...
function TaskList(){
    ...
    const fetchTask=async()=>{
        try {
            const response=await axiosInstance.get('/users/get-user-task')
    ...
    const saveTasks=async(task)=>{
        try{
            console.log(task)
            const response=await axiosInstance.post('/tasks/addTask',task)
            fetchTask()
    ...
    const handleDelete=async()=>{
        ...
        try{
            await Promise.all(
                ...
                axiosInstance.delete(`/tasks/deleteTask/${taskId}`)
                )
            )
